...
class _NetworkPolicyPageState extends State<NetworkPolicyPage> {
  ...
  String get _status {
    ...
    final details = <String>[
      ...
      if (value.rssi case final rssi?) '$rssi dBm',
      if (value.signalLevel case final level?) '信号等级 $level/4',
      if (value.linkSpeedMbps case final speed?) '$speed Mbps',
      if (value.metered) '按流量计费',
      if (value.weakHint) '系统报告网络受限',
      value.preferenceLabel,
    ];
    return '当前：${details.join(' · ')}';
  }
